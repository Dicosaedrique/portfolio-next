...
export default function Contact({ linkedIn, github, devTo, email, color = 'light' }: ContactInfos) {
    return (
        <div className="text-center">
            ...
            {linkedIn && (
                <a className={`btn btn-outline-${color} btn-social mx-1`} href={linkedIn} target="_blank">
                    <i className="fab fa-fw fa-linkedin-in"></i>
                </a>
            )}
            {github && (
                <a className={`btn btn-outline-${color} btn-social mx-1`} href={github} target="_blank">
                    <i className="fab fa-github fa-lg"></i>
                </a>
            )}
            {devTo && (
                <a className={`btn btn-outline-${color} btn-social mx-1`} href={devTo} target="_blank">
